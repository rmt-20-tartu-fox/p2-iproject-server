...
### Deployed server
- https://tartu-fox-livecode2-1st.herokuapp.com/
- https://tartu-fox-livecode2-2nd.herokuapp.com/
- https://tartu-fox-livecode2-3rd.herokuapp.com/
...
>### **Many-to-Many**
Perhatikan relasi antara `User`, `MyCourse`, dan `Course` gunakan definisi relasi yang sesuai pada sequelize relation [doc](https://sequelize.org/master/manual/advanced-many-to-many.html).
